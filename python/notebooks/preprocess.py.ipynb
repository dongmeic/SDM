   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "         x        y  response\n",
       "0  10000.0  10000.0  0.725758\n",
       "1  20000.0  10000.0  0.868562\n",
       "2  30000.0  10000.0  0.630219\n",
       "3  40000.0  10000.0  0.518212\n",
       "4  50000.0  10000.0  0.304101"
      ]
     },
     "execution_count": 2,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<matplotlib.figure.Figure at 0x109f59ef0>"
      ]
     },
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<matplotlib.figure.Figure at 0x109f59a58>"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "Data split into:\n",
      " X_train: (8000, 2)  y_train: (8000,)\n",
      " x range: [0, 99]\ty range: [20, 99]\n",
      "\n",
      " X_valid: (1000, 2)  y_valid: (1000,)\n",
      " x range: [0, 99]\ty range: [10, 19]\n",
      "\n",
      " X_test:  (1000, 2)  y_test:  (1000,)\n",
      " x range: [0, 99]\ty range: [0, 9]\n"
     ]
    }
   ],
   "source": [
